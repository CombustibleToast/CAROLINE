...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let response = "";
        try{
            response += `An application submitted by ${deniedUser} (${deniedUser.tag}) has been denied by ${interaction.user}.\n`;
        }
        catch{
            response += `An application submitted by an unknown user has been denied by ${interaction.user}.\n`;
        }
