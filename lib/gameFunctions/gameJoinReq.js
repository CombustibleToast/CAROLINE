...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`${interaction.user.tag} would like to join the game ${gameData.gameName}.\n
        ...
        try {
            ...
            console.log(`[INFO] Couldn't DM ${gm.tag}:\n${e}`);
            await interaction.channel.send({ content: `${gm.toString()}, I couldn't DM you so I'm sending this here.`, embeds: [embed], components: [buttonRow] });
        }
