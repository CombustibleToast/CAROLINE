...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (gameData.status == "open") {
            ...
            interaction.channel.permissionOverwrites.edit(interaction.guild.id, {'ViewChannel': false}); //interaction.guild snowflake == @everyone snowflake
            ...
            interaction.channel.permissionOverwrites.edit(interaction.guild.id, {'ViewChannel': true});
            let targetCategory;
